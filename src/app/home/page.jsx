    ...
    <Head>
      ...
      <div>
        ...
        <div className="mt-48 mb-48 justify-center items-center flex flex-col">
          ...
          <div className="md:w-[371px] w-[330px] md:h-[614px] p-4 rounded-xl shadow-2xl bg-white hover:scale-105 transition-all mx-auto overflow-clip mb-16 ">
              <h1 className="font-semibold text-2xl mt-4">Echo (iOS Mobile App)</h1>
        ...
        <div>
                  <div className="justify-center mt-32 mb-32 items-center flex flex-col">
                    ...
                    <div className="md:space-y-16 space-y-2 my-6">
                      <div className="grid grid-cols-3 md:gap-16 gap-2 md:my-8 p-4">
                        <Image src={azure} alt="html logo" width={200} height={200} className="md:h-40 mt-4 hover:scale-110 transition-all cursor-pointer" />
                        <Image src={"https://github.com/bensonibeabuchi/capstoneimages/blob/main/images/react.png?raw=true"} alt="react logo" width={100} height={100} className="md:h-40 md:w-40 mt-4 transition-all duration-1000 hover:animate-spin cursor-pointer" />
                        <Image src={"https://github.com/bensonibeabuchi/capstoneimages/blob/main/images/github.png?raw=true"} alt="Github logo" width={100} height={100} className="md:h-40 md:w-40 mt-4 hover:scale-110 transition-all cursor-pointer" />
                        <Image src={restapi} alt="DRF logo" width={100} height={100} className="md:h-40 md:w-40 mt-4 hover:scale-110 transition-all cursor-pointer" />
                        ...
                        <Image src={"https://github.com/bensonibeabuchi/capstoneimages/blob/main/images/Python.png?raw=true"} alt="Python logo" width={100} height={100} className="md:h-40 md:w-40 mt-4 hover:scale-110 transition-all cursor-pointer" />
                        <Image src={"https://github.com/bensonibeabuchi/capstoneimages/blob/main/images/Django.png?raw=true"} alt="Django logo" width={100} height={100} className="md:h-40 md:w-40 mt-4 hover:scale-110 transition-all cursor-pointer" />
                      </div>
