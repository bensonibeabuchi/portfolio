  ...
  return (
    <main className="flex justify-center text-center items-center h-screen">
      <Link href="/home">
        ...
        <h1 className="md:text-xl text-sm md:leading-[50px] leading-[40px] uppercase font-bold transition-all hover:scale-110 bg-clip-text hover:text-transparent hover:bg-gradient-to-r from-[#13B0F5] to-[#E70FAA]">
          Enter Here
        </h1>
      </Link>
    </main>
